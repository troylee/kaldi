...
case $feat_type in
  delta) feats="ark,s,cs:add-deltas --delta-order=2 --delta-window=3 scp:$sdata/JOB/feats.scp ark:- | apply-cmvn $cmvn_opts scp:$sdata/JOB/cmvn_0_d_a.utt.scp ark:- ark:- |";;
