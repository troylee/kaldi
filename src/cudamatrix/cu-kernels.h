 ...
 * cu::
 */
template<typename Real> inline void cuda_relu(dim3 Gr, dim3 Bl, Real *y, const Real *x, MatrixDim d) { KALDI_ERR << __func__ << " Not implemented!"; }
template<typename Real> inline void cuda_diff_relu(dim3 Gr, dim3 Bl, Real *eout, const Real *e, const Real *y, MatrixDim d) { KALDI_ERR << __func__ << " Not implemented!"; }
template<typename Real> inline void cuda_softrelu(dim3 Gr, dim3 Bl, Real *y, const Real *x, MatrixDim d) { KALDI_ERR << __func__ << " Not implemented!"; }
template<typename Real> inline void cuda_diff_softrelu(dim3 Gr, dim3 Bl, Real *eout, const Real *e, const Real *x, MatrixDim d) { KALDI_ERR << __func__ << " Not implemented!"; }
 ...
 * cu::
 */
template<> inline void cuda_relu<float>(dim3 Gr, dim3 Bl, float *y, const float *x, MatrixDim d) { cudaF_relu(Gr,Bl,y,x,d); }
template<> inline void cuda_diff_relu<float>(dim3 Gr, dim3 Bl, float *eout, const float *e, const float *y, MatrixDim d) { cudaF_diff_sigmoid(Gr,Bl,eout,e,y,d); }
template<> inline void cuda_softrelu<float>(dim3 Gr, dim3 Bl, float *y, const float *x, MatrixDim d) { cudaF_relu(Gr,Bl,y,x,d); }
template<> inline void cuda_diff_softrelu<float>(dim3 Gr, dim3 Bl, float *eout, const float *e, const float *x, MatrixDim d) { cudaF_diff_sigmoid(Gr,Bl,eout,e,x,d); }
 ...
 * cu::
 */
template<> inline void cuda_relu<double>(dim3 Gr, dim3 Bl, double *y, const double *x, MatrixDim d) { cudaD_relu(Gr,Bl,y,x,d); }
template<> inline void cuda_diff_relu<double>(dim3 Gr, dim3 Bl, double *eout, const double *e, const double *y, MatrixDim d) { cudaD_diff_sigmoid(Gr,Bl,eout,e,y,d); }
template<> inline void cuda_softrelu<double>(dim3 Gr, dim3 Bl, double *y, const double *x, MatrixDim d) { cudaD_relu(Gr,Bl,y,x,d); }
template<> inline void cuda_diff_softrelu<double>(dim3 Gr, dim3 Bl, double *eout, const double *e, const double *x, MatrixDim d) { cudaD_diff_sigmoid(Gr,Bl,eout,e,x,d); }
